...
# Asteraceae ----------------------------------------------------------
# native
  m1 <- lm(Asteraceae.native ~ pcoldq + pwarmq + amt + ts + arid + th + hii + prop.cover, data = spp.ev)
  summary(m1) 
  m1.sum <- tidy(m1)
  m1.ci <- confint(m1)
# non-native
  m2 <- lm(Asteraceae.non.native ~ pcoldq + pwarmq + amt + ts + arid + th + hii + prop.cover, data = spp.ev)
  summary(m2) 
  m2.sum <- tidy(m2)
  m2.ci <- confint(m2)
...
# Brassicaceae ----------------------------------------------------------
# native
  m3 <- lm(Brassicaceae.native ~ pcoldq + pwarmq + amt + ts + arid + th + hii + prop.cover, data = spp.ev)
  summary(m3) 
  m3.sum <- tidy(m3)
  m3.ci <- confint(m3)
  
# non-native
  m4 <- lm(Brassicaceae.non.native ~ pcoldq + pwarmq + amt + ts + arid + th + hii + prop.cover, data = spp.ev)
  summary(m4) 
  m4.sum <- tidy(m4)
  m4.ci <- confint(m4)
...
# Cyperaceae ----------------------------------------------------------
# native
  m5 <- lm(Cyperaceae.native ~ pcoldq + pwarmq + amt + ts + arid + th + hii + prop.cover, data = spp.ev)
  summary(m5) 
  m5.sum <- tidy(m5)
  m5.ci <- confint(m5)
  
# non-native
  m6 <- lm(Cyperaceae.non.native ~ pcoldq + pwarmq + amt + ts + arid + th + hii + prop.cover, data = spp.ev)
  summary(m6) 
  m6.sum <- tidy(m6)
  m6.ci <- confint(m6)
...
# Fabaceae ----------------------------------------------------------
# native
  m7 <- lm(Fabaceae.native ~ pcoldq + pwarmq + amt + ts + arid + th + hii + prop.cover, data = spp.ev)
  summary(m7) 
  m7.sum <- tidy(m7)
  m7.ci <- confint(m7)
  
# non-native
  m8 <- lm(Fabaceae.non.native ~ pcoldq + pwarmq + amt + ts + arid + th + hii + prop.cover, data = spp.ev)
  summary(m8) 
  m8.sum <- tidy(m8)
  m8.ci <- confint(m8)
...
# Malvaceae ----------------------------------------------------------
# native
  m9 <- lm(Malvaceae.native ~ pcoldq + pwarmq + amt + ts + arid + th + hii + prop.cover, data = spp.ev)
  summary(m9) 
  m9.sum <- tidy(m9)
  m9.ci <- confint(m9)
  
# non-native
  m10 <- lm(Malvaceae.non.native ~ pcoldq + pwarmq + amt + ts + arid + th + hii + prop.cover, data = spp.ev)
  summary(m10) 
  m10.sum <- tidy(m10)
  m10.ci <- confint(m10)
...
# Myrtaceae ---------------------------------------------------------
# native
  m11 <- lm(Myrtaceae.native ~ pcoldq + pwarmq + amt + ts + arid + th + hii + prop.cover, data = spp.ev)
  summary(m11) 
  m11.sum <- tidy(m11)
  m11.ci <- confint(m11)
  
# non-native
  m12 <- lm(Myrtaceae.non.native ~ pcoldq + pwarmq + amt + ts + arid + th + hii + prop.cover, data = spp.ev)
  summary(m12) 
  m12.sum <- tidy(m12)
  m12.ci <- confint(m12)
...
# Plantae ----------------------------------------------------------
# native
  m13 <- lm(Plantae.native ~ pcoldq + pwarmq + amt + ts + arid + th + hii + prop.cover, data = spp.ev)
  summary(m13) 
  m13.sum <- tidy(m13)
  m13.ci <- confint(m13)
  
# non-native
  m14 <- lm(Plantae.non.native ~ pcoldq + pwarmq + amt + ts + arid + th + hii + prop.cover, data = spp.ev)
  summary(m14) 
  m14.sum <- tidy(m14)
  m14.ci <- confint(m14)
...
# Proteaceae ----------------------------------------------------------
# native
  m15 <- lm(Proteaceae.native ~ pcoldq + pwarmq + amt + ts + arid + th + hii + prop.cover, data = spp.ev)
  summary(m15) 
  m15.sum <- tidy(m15)
  m15.ci <- confint(m15)
  
# non-native
# m16 <- lm(Proteaceae.non.native ~ pcoldq + pwarmq + amt + ts + arid + th + hii + prop.cover, data = spp.ev)
# summary(m16) 
# m16.sum <- tidy(m16)
# m16.ci <- confint(m16)
...
# native
  m16 <- lm(Solanaceae.native ~ pcoldq + pwarmq + amt + ts + arid + th + hii + prop.cover, data = spp.ev)
  summary(m16) 
  m16.sum <- tidy(m16)
  m16.ci <- confint(m16)
  
# non-native
  m17 <- lm(Solanaceae.non.native ~ pcoldq + pwarmq + amt + ts + arid + th + hii + prop.cover, data = spp.ev)
  summary(m17) 
  m17.sum <- tidy(m17)
  m17.ci <- confint(m17)
