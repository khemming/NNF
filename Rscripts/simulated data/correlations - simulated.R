...
# data ----------------------------------------------------------------------
  setwd("C:/Users/Hemming/Dropbox/Poaceae/Results/simulated results")
...
# data
  x <- getValues(nonnative.complete)
  y <- getValues(native.complete)
  dat <- data.frame(cbind(x, y))
# labels
  title <- "Complete nonnative invasion"
