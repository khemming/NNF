...
# data ----------------------------------------------
# rasters
  setwd("C:/Users/Hemming/Dropbox/Non-native-families/Results/rasters/scaled")
  ...
  setwd("C:/Users/Hemming/Dropbox/Non-native-families")
...
# data frame --------------------------------------------------------
  ...
  dat <- data.frame(family_long = as.character(family_list_rep),
                    ...
                    status = as.character(rep(c("native", "nonnative"), as.numeric(as.character(nrow(family_list))))),
