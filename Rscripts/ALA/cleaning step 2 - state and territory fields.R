########################################################################
##### cleaning step 1: generating native/non-native 'field' codes ######
########################################################################

# aim --------------------------------------------
# assign State/Terrority tags (fields) to records
# assign preliminary native/non-native status
...
# APC native/non-native [naturalised] tags -------------------------------------
  apc <- read.csv("Data files/ALA/nslsimplename-2015-06-25-2021.csv")
  glimpse(apc)
...
# function to trim leading and trailing white space
  ...
  write.csv(table(c), "Data files/ALA/distribution fields beta.csv")
...
# updated distribution fields
  distr <- read.csv("Data files/ALA/distribution fields updated.csv", header = T) %>%
...
# number of naturalised species
  sum(non_nat_nat) # 2,952 non-natives
...
# output
  write.csv(dat.final, "Data files/ALA/cleaning step 2 - ALA names & status.csv")
