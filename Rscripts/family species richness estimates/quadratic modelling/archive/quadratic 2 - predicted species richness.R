...
# continental-scale cells to predict on to
  pv <- read.csv("Results/csv/families and predictors/predictor variables 1131.csv")
...
# function
  pred_rasterise <- function(raster_df, raster_template, raster_names_df){
    ...
    save <- paste0("Results/rasters/quadratic rasters/", raster_names_df, "_predicted.grd")
